...
class MY_Model extends CI_Model
{
    ...
    public function insert($data, $skip_validation = FALSE)
    {
        ...
        if ($data !== FALSE)
        {
            ...
            //$insert_id = $this->_database->insert_id($this->_table);
            $insert_id = $this->_database->insert_id($this->_table,$this->primary_key); // modify code for ODBC
            //$insert_id = $this->_database->query('SELECT MAX('. $this->primary_key . ') as insert_id from ' . $this->_table)->row('insert_id');
