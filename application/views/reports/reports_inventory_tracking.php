<div class="row">
	<div class="col-lg-12">
        <div id="content-header" class="clearfix">
            ...
            <div class="clearfix">
                <h1 class="pull-left">Inventory Tracking</h1>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group">
                            ...
                            <div ng-hide="advance.AllBranch">
                                <select ng-model="advance.Branch" class="form-control select" id="PoBranch" >
                                    <option ng-repeat="p in branches" ng-value="p.BranchID">{{p.Description}}</option></select>
                            </div>
                        </div>
                        <button ng-click="collapse = !collapse" class="btn btn-primary btn-block"><i class="fa fa-check-circle"></i> Search</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                <div  class="form-group form-inline pull-left">
                    ...
                    <span class="pull-right popover-wrapper">
                        <div class="input-group">
                            <span class="input-group-addon"><a editable-checkbox="advance.Type"
                       e-title="{{(advance.Type) ? 'Search Barcode':'Search IMEI'}}">{{(advance.Type) ? 'Search By IMEI':'Search By Item Code'}}</a></span>
                            <input type="text" ng-keyup="Enter(advance, $event)" class="form-control" ng-model="advance.find" placeholder="Search..." />
                        </div>
                    </span>
                </div>
                <div class="pull-right well well-sm">Available Inventory: {{Available}}</div>
            </header>
            <div class="main-box-body clearfix">
                    ...
                    <table class="table table-hover">
                        <thead>
							<tr>
                                ...
                                <th class="text-center" ng-show="advance.Type"><small>Serial</small></th>
                                <th class="text-center"><small>IN/OUT</small></th>
							</tr>
						</thead>
                        <tbody>
                            <tr ng-repeat="b in filtered = pList | orderBy:'-(SmrID-0)' | DataFilter:(currentPage-1) * pageSize | limitTo:pageSize">
                                <td ng-show="(advance.Type)">
                                ...
                                <td class="text-center" ng-show="advance.Type">{{b.Serial | uppercase}}</td>
                                <td class="text-center">{{b.SumInOut | number:0}}</td>
                            </tr>
                        </tbody>
                    </table>
