<div class="row">
	<div class="col-lg-12">
        <div id="content-header" class="clearfix">
            ...
            <div class="clearfix">
                <h1 class="pull-left">Available Serials</h1>
                    ...
                    <table class="table table-hover">
                        <thead>
							<tr>
                                ...
                                <th class="text-center" permission="[1,2,5,6]"><span>Cost</span></th>
								<th class="text-center" permission="[1,2,5,6]"><span>Price</span></th>
								<th class="text-center"><span>In Date</span></th>
								<th class="text-center">Day/s <small>Ageing</small></th>
							</tr>
						</thead>
                        <tbody>
                            <tr ng-repeat="b in filtered = pList | orderBy:'+ProductDesc' | filter:find | DataFilter:(currentPage-1) * pageSize | limitTo:pageSize">
                                ...
                                <td>{{b.Serial | uppercase}}</td>
                                <td class="text-center"><span class="label" ng-class="{'label-success': (b.IsSold=='0'),'label-warning': (b.IsSold=='2'),'label-info': (b.IsSold=='3')}">{{b.IsSold-0 | serialStatus}}</span></td>
                                ...
                                <td class="text-center">{{b.InDate | dateFilter:'MM-dd-yyyy'}}</td>
                                <td class="text-center">{{b.Ageing}}</td>
                            </tr>
                        </tbody>
                    </table>
