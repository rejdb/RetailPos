	...
	<div class="col-lg-12">
        <div id="content-header" class="clearfix">
            <ol class="breadcrumb">
                ...
                <li class="active"><span>Return History</span></li>
            </ol>
            
            <div class="clearfix">
                <h1 class="pull-left">Sales Return Summary</h1>
                
                <div class="pull-right top-page-ui">
                    <a href="#/sales/return" class="btn btn-success pull-right" style="margin-left:5px">
                        <i class="fa fa-history fa-lg"></i> New Return
                    </a>
                    <button ng-json-export-excel data="pList" report-fields="exportFields" filename ="'Sales Return Summary'" separator=","
                ...
                <form novalidate="novalidate" ng-submit="filter(search.TransID)" name="sFormSingle">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" ng-model="search.TransID" 
                               placeholder="Enter Return Ref Number" required />
                    </div>
