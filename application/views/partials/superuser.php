	...
	<div class="col-lg-12">
		<div id="content-header" class="clearfix">
			<ol class="breadcrumb">
				...
				<li class="active"><span>Superusers</span></li>
			</ol>
		
			<div class="clearfix">
				<h1 class="pull-left">Super Users <small>manage application super user</small></h1>
				
				<div class="pull-right top-page-ui">
					<button class="btn btn-primary pull-right" data-toggle="modal" data-target="#mySuperUser">
						<i class="fa fa-plus-circle fa-lg"></i> Add Super Admin
					</button>
				</div>
			</div>
		</div>
...
<div class="modal fade" id="mySuperUser" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="wizard-container">
            <div class="card wizard-card ct-wizard-red" id="wizardProfile">
                <form ng-submit="saveSuperuser()" novalidate="novalidate">
                    <div class="wizard-header">
                        <div class="h3">
                            <b>CREATE</b> SUPER ADMIN
...
<script src="/resources/js/app/superuser.js"></script>
