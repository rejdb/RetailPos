<div class="row">
	<div class="col-lg-12">
        <div id="content-header" class="clearfix">
            ...
            <div class="clearfix">
                <h1 class="pull-left">Transfer History</h1>
                
                <div class="pull-right top-page-ui">
                    <a href="#/stocks/transfer" class="btn btn-success pull-right" style="margin-left:5px">
                        <i class="fa fa-history fa-lg"></i> New Transfer
                    </a>
                    <button ng-json-export-excel data="pList" report-fields="exportFields" filename ="'Transfer Summary'" separator=","
                    ...
                    <table class="table user-list table-hover">
                        ...
                        <tbody>
                            <tr ng-repeat="b in filtered = pList | orderBy:'+TransDate' | filter:find | DataFilter:(currentPage-1) * pageSize | limitTo:pageSize">
                                ...
                                <td class="text-center" ng-bind="Filler(b.InvTo, b.TransferType)"></td>
                                ...
                                <td style="width: 12%;">
                                    ...
                                    <span ng-class="{'hidden': (b.Status!='1')}">
                                        <a ng-click="TransferStatus(b.TransID, 2, b.InvTo-0)" 
                                           permission="[1,5]"
                                        ...
                                        <a ng-click="TransferStatus(b.TransID, 4, b.InvTo-0)" class="table-link danger">
                                            <span class="fa-stack">
                                                <i class="fa fa-square fa-stack-2x"></i>
                                    ...
                                    <a ng-click="TransferStatus(b.TransID, 3, b.InvTo-0)" 
                                    ...
                                    <a ng-click="TransferStatus(b.TransID, 4, b.InvTo-0)" 
                                       ng-show="(b.Status==2 && b.InvTo==userProfile.Branch.BranchID)"
                                       class="table-link danger">
                                        <span class="fa-stack">
                                            <i class="fa fa-square fa-stack-2x"></i>
