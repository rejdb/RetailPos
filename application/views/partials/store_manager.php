                ...
                <div class="pull-right top-page-ui">
                    <a data-toggle="modal" data-target="#myStoreManager"
                       class="btn btn-primary pull-right">
                        <i class="fa fa-plus-circle fa-lg"></i> Add manager
                    </a>
                </div>
            </div>
        </div>
...
<div class="modal fade" id="myStoreManager" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-md" role="document">
        <div class="wizard-container">
            <div class="card wizard-card ct-wizard-red" id="wizardProfile">
                <form ng-submit="addStoreManager()" novalidate="novalidate">
                    <div class="wizard-header">
                        <div class="h3">
                            <b>ADD NEW</b> STORE MANAGER
...
<script src="/resources/js/app/manager.js"></script>