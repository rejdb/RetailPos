...
, IFNULL((SELECT MAX(BankName) FROM view_sales_payments I0 WHERE I0.TransID = T0.TransID and I0.BankName != 'HOME CREDIT'),(SELECT MAX(BankName) FROM view_sales_payments I0 WHERE I0.TransID = T0.TransID and I0.BankName = 'HOME CREDIT')) as BankTerminal
, IFNULL((SELECT MAX(InstDesc) FROM view_sales_payments I0 WHERE I0.TransID = T0.TransID and I0.PaymentType != 1),'Cash') as Terms
, IFNULL((SELECT MAX(RefNumber) FROM view_sales_payments I0 WHERE I0.TransID = T0.TransID and I0.PaymentType != 1 and I0.Terminal!=6),'') as PaymentRefNumber
, IFNULL((SELECT MAX(RefNumber) FROM view_sales_payments I0 WHERE I0.TransID = T0.TransID and I0.PaymentType != 1 and I0.Terminal=6),'') as PaymentRefNumber_hc
