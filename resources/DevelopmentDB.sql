...
CREATE DATABASE IF NOT EXISTS `pos_development` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `pos_development`;
...
--
-- Dumping data for table `ref_item_brand`
--

INSERT INTO `ref_item_brand` (`BrandID`, `Description`) VALUES
(2, 'LENOVO'),
(1, 'NOKIA'),
(3, 'OPPO');
...
--
-- Dumping data for table `ref_item_category`
--

INSERT INTO `ref_item_category` (`P_CatID`, `Description`) VALUES
(2, 'ACCESSORIES'),
(1, 'DEVICE');
...
--
-- Dumping data for table `ref_item_cycle`
--

INSERT INTO `ref_item_cycle` (`P_CycleID`, `Description`) VALUES
(1, 'ACTIVE'),
(2, 'END OF LIFE');
...
--
-- Dumping data for table `ref_item_family`
--

INSERT INTO `ref_item_family` (`FamID`, `Description`) VALUES
(3, 'LENOVO'),
(1, 'NOKIA'),
(2, 'OPPO');
...
INNER JOIN md_branches t3 on t2.BranchID = t3.BranchID;
...
LEFT JOIN ref_terminal T2 ON T0.Terminal = T2.BankID
...
SELECT T0.*
,T1.BranchCode,T1.Description as BranchDesc,T1.CategoryDesc,T1.ChannelDesc,T1.CityDesc,T1.TypeDesc,T1.GroupDesc
,T2.BarCode,T2.ProductDesc,T2.SKU,T2.BrandDesc,T2.CategoryDesc as ItemCategory,T2.CycleDesc,T2.StdCost,T2.CurrentPrice,T3.WhsName
...
--
ALTER TABLE `ref_item_category`
  MODIFY `P_CatID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ref_item_cycle`
--
ALTER TABLE `ref_item_cycle`
  MODIFY `P_CycleID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `ref_item_family`
--
ALTER TABLE `ref_item_family`
  MODIFY `FamID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
